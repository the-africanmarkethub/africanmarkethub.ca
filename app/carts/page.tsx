  ...
  return (
    <div className="bg-gray-50 py-8">
      ...
      >
        ...
        />
        {error && <p className="text-hub-secondary text-sm mb-2">{error}</p>}
        <div className="flex justify-end gap-2 mt-4">
          ...
          <button
            ...
            className="px-4 py-2 bg-hub-secondary text-white rounded-md hover:bg-hub-secondary cursor-pointer disabled:opacity-50"
          >
