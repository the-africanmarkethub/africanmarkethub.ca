...
import { Order, OrderStatusTracker } from "@/app/track-order/components/OrderStatusTracker";
   ...
   <>
     <div className="card mb-6">
       ...
       <p className="text-sm mt-1 text-gray-600">
         ...
         <span className="text-orange-800"> Order </span>
       </p>
     </div>
     ...
     {!order && !loading && (
       <div className="text-center py-10 border-2 border-dashed border-orange-200 rounded-lg">
