            ...
            {tutorials.map((tutorial, index) => (
              ...
              >
                ...
                <div className="p-6 flex flex-col grow">
                  <h3 className="text-xl font-bold text-gray-900 line-clamp-2 mb-3 group-hover:text-orange-600 transition-colors">
                    {tutorial.title}
                  </h3>
                  ...
                  <motion.div whileTap={{ scale: 0.95 }}>
                    <Link
                      ...
                      className="block w-full py-3 bg-orange-500 hover:bg-orange-600 text-white text-center font-bold rounded-xl transition-all shadow-md hover:shadow-orange-200"
                    >
                      Read More
                    </Link>
                  </motion.div>
          ...
          {hasMore && (
            <div className="flex justify-center mt-12">
              <motion.button
                ...
                className="px-10 py-3 border-2 border-orange-500 text-orange-500 font-bold rounded-xl hover:bg-orange-500 hover:text-white disabled:opacity-50 transition-all duration-300 shadow-sm"
              >
                {fetchingMore ? (
