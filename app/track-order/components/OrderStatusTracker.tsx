  ...
  return (
    <div aria-label="Order status tracker">
      <div className="flex justify-between items-center mb-2">
        ...
        <span className="bg-green-100 text-hub-secondary text-xs font-semibold px-3 py-1 rounded-full capitalize">
              ...
              <div className="flex flex-col items-center">
                <div
                  className={clsx(
                    ...
                    {
                      "bg-hub-secondary text-white": isCompleted,
