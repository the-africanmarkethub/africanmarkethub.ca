...
export function NotificationMenu() {
  ...
  return (
    <Menu as="div" className="relative">
      <MenuButton className="p-2 text-gray-500 hover:text-orange-500 relative transition-colors duration-150 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 cursor-pointer">
          ...
          <div className="max-h-96 overflow-y-auto">
            ...
            {!isLoading &&
              ...
              notifications.map((notif) => (
                ...
                >
                  ...
                  <div
                    className={classNames(
                      true ? "text-orange-600" : "text-gray-500",
                      "mt-1 mr-3 shrink-0"
                    )}
                  >
            ...
            {/* <div className="border-t border-gray-100">
              <Link
                ...
                className="block w-full text-center py-2 text-sm font-medium text-orange-600 hover:bg-gray-50"
              >
