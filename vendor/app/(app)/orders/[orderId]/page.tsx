...
import { type Customer } from "@/components/order/customer-info";
...
export default function OrderDetailsPage({
  ...
  const { data, isLoading, error } = useGetSingleOrder(params.orderId);
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex items-center gap-x-2 justify-end md:hidden">
            <Badge 
              className="px-3" 
              variant={
                orderDetail.payment_status === 'paid' ? 'success' : 
                orderDetail.payment_status === 'failed' ? 'destructive' : 'warning'
              }
            >
            ...
            <Badge 
              className="px-3" 
              variant={
                orderDetail.shipping_status === 'delivered' ? 'success' :
                orderDetail.shipping_status === 'cancelled' ? 'destructive' : 'warning'
              }
            >
