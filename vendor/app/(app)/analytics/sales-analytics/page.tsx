...
import TopListCard from "@/components/analytics/top-list-card";
import CountryStats from "@/components/analytics/country-stats";
import SimpleOrderTable from "@/components/dashboard/simple-order-table";
import { useTopCategories } from "@/hooks/useTopCategories";
import { useTopProducts } from "@/hooks/useTopProducts";
import { useTopCustomerLocations } from "@/hooks/useTopCustomerLocations";
import { useSalesAnalytics } from "@/hooks/useSalesAnalytics";
import WorldMapEnhanced from "@/components/analytics/WorldMapEnhanced";
import {
  CategoryData,
  ProductData,
  LocationData,
...
const VisitedPagesPieChart = dynamic(
  () => import("@/components/analytics/VisitedPagesPieChart"),
  { ssr: false }
);
