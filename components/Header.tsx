          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            {user ? (
              <button
                ...
                className="md:hidden p-2 text-gray-600 hover:text-[#F28C0D] transition-colors"
              >
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
            ...
            {user ? (
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {/* Dropdown Menu */}
                {showDropdown && (
                  <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50 sm:block hidden">
                    {/* User Info */}
                ...
                {showDropdown && (
                  <div className="sm:hidden fixed inset-x-0 top-16 bg-white border-t border-gray-200 shadow-lg z-50">
                    <div className="max-w-7xl mx-auto px-4 py-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <button
                          ...
                          className="flex items-center w-full px-3 py-3 text-red-600 hover:bg-gray-50 rounded-lg"
                        >
                          <svg
                            className="w-5 h-5 mr-3"
                            fill="none"
