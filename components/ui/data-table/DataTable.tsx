        ...
        <Table className="min-w-full sm:min-w-[800px] md:min-w-0">
          <TableHeader className="bg-[#FFFBED] border-t-2 border-b-2 border-primary">
            <TableRow>
              ...
              {rowActions && <TableHead className="min-w-[100px] whitespace-nowrap">Actions</TableHead>}
            </TableRow>
          </TableHeader>
            ...
            {data.map((item) => (
              <TableRow key={item.id}>
                ...
                {columns.map((column) => (
                  ...
                  >
                    <div className="max-w-[200px] truncate" title={column.cell ? undefined : getNestedValue(item, String(column.accessorKey))}>
                      {column.cell
                        ? column.cell(item)
                ...
                {rowActions && <TableCell className="min-w-[100px] px-3 py-4">{rowActions(item)}</TableCell>}
              </TableRow>
            ))}
          </TableBody>
        </Table>
