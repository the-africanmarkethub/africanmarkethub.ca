...
import PopularProductCategory from "@/components/home/PopularProductCategory";
import ShopByCategory from "@/components/home/ShopByCategory";
import PopularServiceCategory from "@/components/home/PopularServiceCategory";
import TodaysDeal from "@/components/home/TodaysDeal";
import WhatsTrendingNow from "@/components/home/WhatsTrendingNow";
...
export default function Home() {
  ...
  return (
    <div>
      {/* Hero Section */}
      <div className="py-11 bg-[#FFFBED] mb-[43px]">
        <MaxWidthWrapper className="flex gap-8 flex-col md:flex-row">
          ...
          <div className="md:space-y-6 w-full md:w-[624px]">
            ...
            <div className="flex gap-4 items-center">
              ...
              <Link href="/sign-up">
                <SubmitButton className="w-[120px] text-sm md:w-[153px] bg-[#FFFFFF] text-[#0D0C0D] hover:bg-[#FFFFFF] border border-secondary rounded-[39px] h-14">
                  Get started
                </SubmitButton>
              </Link>
            </div>
