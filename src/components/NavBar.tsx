  ...
  return (
    <div className="w-full  fixed  w-screen-xl top-0 left-0 z-50" ref={menuRef}>
                ...
                <div className="space-y-1">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      if (token) {
                        window.open(
                          process.env.NEXT_PUBLIC_VENDOR_URI ||
                            "http://localhost:3001/create-shop",
                          "_blank"
                        );
                      } else {
                        toast.error(
                          "Please login first to access the vendor portal"
                        );
                        setTimeout(() => {
      ...
      <div className="bg-primary hidden md:flex">
        <div className="flex  md:px-[60px] lg:px-[100px] gap-[163px] items-center">
          <CategoriesPopover />
          ...
          <Button
            ...
            onClick={() => {
              ...
              if (token) {
                ...
                toast.error("Please login first to access the vendor portal");
                setTimeout(() => {
                  window.location.href = "/sign-in";
                }, 1500);
              }
